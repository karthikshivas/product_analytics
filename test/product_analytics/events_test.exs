defmodule ProductAnalytics.EventsTest do
  ...
  describe "events" do
    ...
    test "create_event/1 with valid data creates a event" do
      valid_attrs = %{attributes: %{}, user_id: "some user_id", event_time: ~U[2024-04-24 07:35:00Z], event_name: "some event_name"}
    ...
    test "update_event/2 with valid data updates the event" do
      event = event_fixture()
      update_attrs = %{attributes: %{}, user_id: "some updated user_id", event_time: ~U[2024-04-25 07:35:00Z], event_name: "some updated event_name"}
